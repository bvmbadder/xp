...
const TabModal = ({ isOpen, onClose, value }: ModalWithTabsProps) => {
  ...
  return (
    ...
    >
      <div className="bg-white text-black p-6 rounded w-11/12 md:w-2/3 lg:w-1/2">
        ...
        <ul className="flex">
          <li className="-mb-px mr-1">
            <button
              className={`tab bg-gray-800 inline-block py-2 px-4 text-white font-medium text-sm md:text-base ${
          ...
          <li className="mr-1">
            <button
              className={`tab bg-black inline-block py-2 px-4 text-white font-medium text-sm md:text-base ${
